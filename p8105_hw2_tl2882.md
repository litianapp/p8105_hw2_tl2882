...
In Mr.Trash Wheel dataset, the number of observation is `285`. The key variable I choose is "Dumpster".

In percipitation dataset, the number of observation is `24`. The key variable I choose is "Total".
